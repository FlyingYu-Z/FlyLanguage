...
public:
  ...
  enum {
    ...
    RuleFunctionParameter = 5, RuleBlock = 6, RuleStat = 7, RuleJudgeSymbol = 8, 
  ...
  class  InvokeStmtContext : public StatContext {
  public:
    InvokeStmtContext(StatContext *ctx);
  ...
  class  CodeBlockContext : public StatContext {
  public:
    CodeBlockContext(StatContext *ctx);
  ...
  class  IfElseStmtContext : public StatContext {
  public:
    IfElseStmtContext(StatContext *ctx);
  ...
  class  AssignStmtContext : public StatContext {
  public:
    AssignStmtContext(StatContext *ctx);
  ...
  class  ReturnStmtContext : public StatContext {
  public:
    ReturnStmtContext(StatContext *ctx);
  ...
  class  VarStmtContext : public StatContext {
  public:
    VarStmtContext(StatContext *ctx);
